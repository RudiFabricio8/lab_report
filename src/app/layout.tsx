                ...
                <div className="flex h-screen bg-gray-50">
                    ...
                    <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
                        ...
                        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                            <NavItem href="/" icon="🏠" label="Dashboard Principal" />

                            <div className="pt-4 pb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">
                                Reportes
                            </div>

                            <NavItem href="/reports/sales-category" icon="📦" label="Ventas por Categoría" />
                            <NavItem href="/reports/top-products" icon="🏆" label="Productos Top" />
                            <NavItem href="/reports/customer-summary" icon="👥" label="Clientes VIP" />
                            <NavItem href="/reports/order-status" icon="🚚" label="Status Órdenes" />
                            <NavItem href="/reports/daily-sales" icon="📅" label="Ventas Diarias" />
                        </nav>
